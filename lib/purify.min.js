...
!(function (e, t) {
  ...
  return (function e() {
    ...
    var pe = z,
      ...
      it = function (e) {
        (rt && rt === e) ||
          ...
          e.FORBID_CONTENTS &&
            (Be === We && (Be = w(Be)), S(Be, e.FORBID_CONTENTS)),
          Ue && (Ae["#text"] = !0),
    ...
    var ut = function (e) {
      ...
      bt = function (e, t, n) {
        if (He && ("id" === t || "name" === t) && (n in o || n in ot))
          return !1;
        if (Ne && !Re[t] && T(ge, t));
        else if (_e && T(ye, t));
        else {
      ...
      At = function e(t) {
        ...
        for (yt("beforeSanitizeShadowDOM", t, null); (n = r.nextNode()); )
          yt("uponSanitizeShadowNode", n, null),
            vt(n) || (n.content instanceof a && e(n.content), Tt(n));
    ...
    return (
      (n.sanitize = function (e, o) {
        var i = void 0,
          ...
          m = void 0;
        if (
          ((Je = !e) && (e = "\x3c!--\x3e"), "string" != typeof e && !gt(e))
        ) {
        ...
        if (
          (Me || it(o), (n.removed = []), "string" == typeof e && (Pe = !1), Pe)
        );
        ...
        for (var f = pt(Pe ? e : i); (s = f.nextNode()); )
          (3 === s.nodeType && s === u) ||
            vt(s) ||
            (s.content instanceof a && At(s.content), Tt(s), (u = s));
